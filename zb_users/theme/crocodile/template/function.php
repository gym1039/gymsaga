<?php
require dirname(__FILE__) . DIRECTORY_SEPARATOR . 'custommoudle.php';
...
function GetArticleImg($article) {
	...
	if(isset($matchContent[1][0]))
		...
		$temp=$zbp->host."zb_users/theme/".$zbp->theme."/style/images/random/$temp.jpg";

	 return $temp;
}

function CustomMoudle(){
	NewArticle();
	HotArticle();
	MostComment();	
	Advert();	
 ...
 * @return string 
*/
function SubStrStartUTF8($sourcestr,$startstr,$cutlength) {
	global $zbp;
