...
<html lang="zh-CN">
    <head>
		...
		<link rel='stylesheet' id='an_style-css' href='{$host}zb_users/theme/{$theme}/style/style.css' type='text/css' media='all' />	
        <link rel='stylesheet' id='an_style-css' href='{$host}zb_users/theme/{$theme}/style/2qHyADmDDdGA.css' type='text/css' media='all' />
        <link rel="shortcut icon" href="{$host}zb_users/theme/{$theme}/style/images/favicon.ico" title="Favicon" />
		...
		<div id="top-bar" class="navbar navbar-inverse">
			<div id="logo">
				<hgroup itemscope itemtype="http://schema.org/WPHeader">
					<h1 class="logoimg">
						<a href="{$host}" title="{$name}" rel="home">{$name}</a>
					</h1>
				</hgroup>
			</div>
			<ul class="nav user-nav">
				...
				<li class="dropdown" id="profile-messages">
					<a title="" href="{$host}zb_system/cmd.php?act=logout" class="dropdown-toggle">
				...
				<li class="user-btn user-reg">
					<a class="popup-register" href="{$zbp->Config('crocodile')->YLink}" title="QQ邮箱订阅" rel="nofollow">
				...
				<li id="qqqun" class="other-nav">
					<a target="_blank" title="技术交流群" href="{$zbp->Config('crocodile')->QGroup}" rel="nofollow">
						<i class="fa fa-group fa-fw">
						</i>
						加入Q群
					</a>
				</li>
				{$zbp->Config('crocodile')->ToolBar}
			</ul>
			<div id="search">
				...
				<div class="search-expand">
					<div class="search-expand-inner">
						<form method="post" class="searchform themeform" action="{$host}zb_system/cmd.php?act=search" target="_blank">
							<div>
