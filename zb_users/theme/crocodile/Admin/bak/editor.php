...
if ($zbp->Config('crocodile')->HasKey('version')) {
	$strlayout=$zbp->Config('crocodile')->custom_layout;
	$strBodyBg=$zbp->Config('crocodile')->custom_bodybg;
	$strHdBg=$zbp->Config('crocodile')->custom_hdbg;
	$strColor=$zbp->Config('crocodile')->custom_color;
...
<script type="text/javascript">ActiveTopMenu("topmenu_crocodile");</script>
<?php
